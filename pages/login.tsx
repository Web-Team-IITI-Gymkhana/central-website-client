...
export default function login() {
  return (
    <div className='flex h-[100vh] w-[100vw] bg-[rgb(33,11,98)] items-center '>
      <div className='flex flex-col  h-[75vh] w-[25vw] mx-auto bg-white rounded-lg items-center shadow-md shadow-current'>
        ...
        <div className='flex flex-row w-64 h-12 border-2 mt-8 text-sm p-1' id='sign-in'> Sign in as
